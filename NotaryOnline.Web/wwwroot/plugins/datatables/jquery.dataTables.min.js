...
sNext:"Вперед",sPrevious:"Назад"},sEmptyTable:"Нет данных",sInfo:"Показаны строки от _START_ до _END_ из _TOTAL_",sInfoEmpty:"Показано 0 строк",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
